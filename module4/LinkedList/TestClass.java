public class TestClass {
    public static void main(String[] args) {
        ...
        // // should be setNext();
        // listHead.getNext().setPrev(listHead);
        ...
        // System.out.println(listHead.getNext().getNext().concatenate());
        ...
        // listHead = listHead.removeNode(listHead.getNext());
        // listHead.printListFromHere();
        ...
        System.out.println(listy.length());
