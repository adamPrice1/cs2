...
public class BinaryTree {
    ...
    public boolean hasSameContentsAs(BinaryTree tree) {
        return tree.getAllTreeData().equals(this.getAllTreeData());
    }

    public ArrayList<String> getAllTreeData() {

        ArrayList<String> result = new ArrayList<String>();
        // base case in this case is a leaf
        if (data != null) {
            result.add(data);
        ...
        if (leftChild != null) {
            result.addAll(leftChild.getAllTreeData());
        }
        if (rightChild != null) {
            result.addAll(rightChild.getAllTreeData());
        }
