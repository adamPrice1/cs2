public class BinaryTreeTest {
        public static void main(String[] args) {
                ...
                trees[2] = new BinaryTree("A", new BinaryTree("B", new BinaryTree("C"), null), new BinaryTree("D"));

                trees[3] = new BinaryTree("A", null, new BinaryTree("C", new BinaryTree("D"), new BinaryTree("E",
                                new BinaryTree("F", new BinaryTree("G"), null), new BinaryTree("H"))));

                trees[4] = new BinaryTree("A", new BinaryTree("B", new BinaryTree("C", new BinaryTree("D"),
                ...
                trees[5] = new BinaryTree("A", null,
                                new BinaryTree("P", null, new BinaryTree("R", null, new BinaryTree("U"))));

                trees[6] = new BinaryTree("A", null, new BinaryTree("P", null,
                                new BinaryTree("R", new BinaryTree("W"), new BinaryTree("U"))));

                trees[7] = new BinaryTree("A", new BinaryTree("B", new BinaryTree("C", null,
                                new BinaryTree("E", new BinaryTree("F", new BinaryTree("G"), new BinaryTree("I")),
                                                new BinaryTree("H"))),
                                new BinaryTree("J",
                                                new BinaryTree("K", null,
